      ...
      <td>
        ...
        <table width="100%"  border="0" align="center" cellpadding="0" class="fullwidth">
            <tr>
                <td>
                  Inserir imagem : &nbsp;
                  <input name="<? echo $_config['id_column']; ?>" type="hidden" value="<? echo $id; ?>" class="field">
...
<form id="multiple_op" method="post" action="?<? echo($_module); ?>/delete_images">
<input type="hidden" value="<? echo $id; ?>" name="<? echo($_config['id_column']); ?>"/>
